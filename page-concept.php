...
?> 
  ...
  <section id="section-contects" class="concept">
    ...
    <div class="concept-detail__inner">
      <div class="concept-detail__inner--flex">
        <img class="flex-image fade-in" src="<?php echo get_template_directory_uri(); ?>/assets/images/A-TECH-TEST-image/test-image/img/page-concept_about.jpg" 
        loading="lazy"
        alt="コンセプト画像１">
  ...
  <section id="company-profile">
    <div class="company-profile__inner">
      ...
      <img class="company-profile__inner--image-pc fade-in" src="<?php echo get_template_directory_uri(); ?>/assets/images/A-TECH-TEST-image/test-image/img/page-concept_profile-pc.jpg" 
        loading="lazy"
        alt="コンセプトpc画像2">

      <img class="company-profile__inner--image-sp fade-in" src="<?php echo get_template_directory_uri(); ?>/assets/images/A-TECH-TEST-image/test-image/img/page-concept_profile-sp.jpg" 
        loading="lazy"
        alt="コンセプトsp画像2">  
        ...
        <div class="info-row fade-in">
          ...
          <div class="info-content">〒000-0000 <br class="brsp"> 東京都港区青山0-00-00</div>
        </div>
        <div class="info-row border fade-in">
          <div class="info-title">電話番号</div>
          <div class="info-content">000-0000-0000</div>
        </div>
        <div class="info-row fade-in">
